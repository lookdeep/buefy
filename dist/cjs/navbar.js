...
function processArgs(bindingValue) {
  ...
  if (!isFunction && _typeof._typeof(bindingValue) !== 'object') {
    throw new Error("v-click-outside: Binding value should be a function or an object, ".concat(_typeof._typeof(bindingValue), " given"));
  }
