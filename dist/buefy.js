...
(function (global, factory) {
                  ...
                  (element.group)
                    ? (vue.openBlock(), vue.createBlock("div", {
                        ...
                        ($options.hasGroupSlot)
                          ...
                          : (vue.openBlock(), vue.createBlock("span", _hoisted_2$k, vue.toDisplayString(element.group), 1 /* TEXT */))
                      ]))
                    : vue.createCommentVNode("v-if", true),
                  (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(element.items, (option, index) => {
                    return (vue.openBlock(), vue.createBlock("a", {
                      ...
                      ($options.hasDefaultSlot)
                        ...
                        : (vue.openBlock(), vue.createBlock("span", _hoisted_3$f, vue.toDisplayString($options.getValue(option, true)), 1 /* TEXT */))
                    ], 10 /* CLASS, PROPS */, ["onClick"]))
                  }), 128 /* KEYED_FRAGMENT */))
                ], 64 /* STABLE_FRAGMENT */))
              }), 256 /* UNKEYED_FRAGMENT */)),
              ($options.isEmpty && $options.hasEmptySlot)
                ? (vue.openBlock(), vue.createBlock("div", _hoisted_4$a, [
                    vue.renderSlot(_ctx.$slots, "empty")
                  ]))
                : vue.createCommentVNode("v-if", true),
              ($options.hasFooterSlot)
                ? (vue.openBlock(), vue.createBlock("div", _hoisted_5$7, [
    ...
    return (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.computedTag), vue.mergeProps({ class: "button" }, _ctx.$attrs, {
      ...
      default: vue.withCtx(() => [
        ($props.iconLeft)
          ...
          : vue.createCommentVNode("v-if", true),
        ($props.label)
          ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$D, vue.toDisplayString($props.label), 1 /* TEXT */))
          : (_ctx.$slots.default)
            ? (vue.openBlock(), vue.createBlock("span", _hoisted_2$j, [
                vue.renderSlot(_ctx.$slots, "default")
              ]))
            : vue.createCommentVNode("v-if", true),
        ($props.iconRight)
  ...
  function render$R(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      ($props.autoplay && $props.pauseHover && $props.pauseInfo && $data.isPause)
        ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$C, [
  ...
  function render$Q(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock(vue.Transition, { name: $options.transition }, {
      default: vue.withCtx(() => [
        vue.withDirectives(vue.createVNode("div", _hoisted_1$B, [
          vue.renderSlot(_ctx.$slots, "default")
        ], 512 /* NEED_PATCH */), [
  ...
  function render$O(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("label", {
      ...
      vue.createVNode("span", _hoisted_1$A, [
        vue.renderSlot(_ctx.$slots, "default")
      ])
  ...
  function render$L(_ctx, _cache, $props, $setup, $data, $options) {
    return ($props.separator)
      ? (vue.openBlock(), vue.createBlock("hr", _hoisted_1$z))
    ...
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      ($props.horizontal)
        ...
        : ($options.hasInnerField)
          ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$y, [
  ...
  function render$J(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      vue.createVNode("div", _hoisted_1$x, [
        vue.createVNode("div", {
        ...
        ? (vue.openBlock(), vue.createBlock(_component_b_dropdown, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode("div", {
                ...
                (_ctx.inline)
                  ? (vue.openBlock(), vue.createBlock("header", _hoisted_1$w, [
                      vue.createVNode("div", _hoisted_2$i, [
                        vue.createVNode("div", _hoisted_3$e, [
                          vue.createVNode("span", {
                        ...
                        (!_ctx.isHourFormat24)
                          ? (vue.openBlock(), vue.createBlock("div", _hoisted_4$9, [
                              vue.createVNode("div", {
                ...
                vue.createVNode("div", _hoisted_5$6, [
                  vue.createVNode("div", {
                    ...
                    (!_ctx.isHourFormat24 && !_ctx.inline)
                      ? (vue.openBlock(), vue.createBlock("div", _hoisted_7$4, [
                          vue.createVNode("div", {
                            class: ["b-clockpicker-btn", {
                                      active: _ctx.meridienSelected === _ctx.amString || _ctx.meridienSelected === _ctx.AM
                                  }],
                ...
                (_ctx.$slots.default !== undefined && _ctx.$slots.default().length)
                  ? (vue.openBlock(), vue.createBlock("footer", _hoisted_8$3, [
                      vue.renderSlot(_ctx.$slots, "default")
                    ]))
                  : vue.createCommentVNode("v-if", true)
              ], 8 /* PROPS */, ["disabled"])
          ...
          ($props.placeholder)
            ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
                ($options.computedValue == null)
                  ? (vue.openBlock(), vue.createBlock("option", _hoisted_1$v, vue.toDisplayString($props.placeholder), 1 /* TEXT */))
                  : vue.createCommentVNode("v-if", true)
              ], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */))
            : vue.createCommentVNode("v-if", true),
          vue.renderSlot(_ctx.$slots, "default")
  ...
  function render$G(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", _hoisted_1$u, [
          ...
          ($options.selectableDate(weekDay) && !$props.disabled)
            ? (vue.openBlock(), vue.createBlock("a", {
                ...
                ($options.eventsDateMatch(weekDay))
                  ? (vue.openBlock(), vue.createBlock("div", _hoisted_2$h, [
            ...
            : (vue.openBlock(), vue.createBlock("div", {
                ...
                vue.createVNode("span", null, vue.toDisplayString(weekDay.getDate()), 1 /* TEXT */),
                ($options.eventsDateMatch(weekDay))
                  ? (vue.openBlock(), vue.createBlock("div", _hoisted_3$d, [
                      (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($options.eventsDateMatch(weekDay), (event, evIdx) => {
                        return (vue.openBlock(), vue.createBlock("div", {
                          class: ["event", event.type],
                          key: evIdx
  ...
  function render$F(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createBlock("section", _hoisted_1$t, [
      vue.createVNode("header", _hoisted_2$g, [
  ...
  function render$E(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("section", _hoisted_1$s, [
      vue.createVNode("div", {
        class: ["datepicker-body", {'has-events':$options.hasEvents}]
      }, [
        vue.createVNode("div", _hoisted_2$f, [
              ...
              ($options.selectableDate(date) && !$props.disabled)
                ? (vue.openBlock(), vue.createBlock("a", {
                    ...
                    ($options.eventsDateMatch(date))
                      ? (vue.openBlock(), vue.createBlock("div", _hoisted_3$c, [
              ...
              vue.createVNode(_component_b_dropdown_item, {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode("div", null, [
                    vue.createVNode("header", _hoisted_1$r, [
                      (_ctx.$slots.header !== undefined)
                        ...
                        : (vue.openBlock(), vue.createBlock("div", {
                            ...
                            vue.createVNode("div", _hoisted_2$e, [
                    ...
                    (!$options.isTypeMonth)
                      ...
                      : (vue.openBlock(), vue.createBlock("div", _hoisted_3$b, [
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_b_field, {
                    ...
                    default: vue.withCtx(() => [
                      ...
                      vue.createVNode("span", _hoisted_1$q, vue.toDisplayString(_ctx.hourLiteral), 1 /* TEXT */),
                      vue.createVNode(_component_b_select, {
                      ...
                      (_ctx.enableSeconds)
                        ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
                            vue.createVNode("span", _hoisted_2$d, vue.toDisplayString(_ctx.minuteLiteral), 1 /* TEXT */),
                            vue.createVNode(_component_b_select, {
                            ...
                            vue.createVNode("span", _hoisted_3$a, vue.toDisplayString(_ctx.secondLiteral), 1 /* TEXT */)
                          ], 64 /* STABLE_FRAGMENT */))
                        : vue.createCommentVNode("v-if", true),
                      (!_ctx.isHourFormat24)
                        ? (vue.openBlock(), vue.createBlock(_component_b_select, {
                  ...
                  (_ctx.$slots.default !== undefined)
                    ? (vue.openBlock(), vue.createBlock("footer", _hoisted_4$8, [
                        vue.renderSlot(_ctx.$slots, "default")
                      ]))
                    : vue.createCommentVNode("v-if", true)
                ]),
  ...
  function render$B(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (!$options.isMobile || $props.inline)
      ? (vue.openBlock(), vue.createBlock(_component_b_datepicker, vue.mergeProps({
          ...
          default: vue.withCtx(() => [
            vue.createVNode("nav", _hoisted_1$p, [
              (_ctx.$slots.left !== undefined)
                ? (vue.openBlock(), vue.createBlock("div", _hoisted_2$c, [
              ...
              (_ctx.$slots.right !== undefined)
                ? (vue.openBlock(), vue.createBlock("div", _hoisted_4$7, [
      ...
      default: vue.withCtx(() => [
        ($data.isActive)
          ? vue.withDirectives((vue.openBlock(), vue.createBlock("div", {
              ...
              vue.createVNode("div", _hoisted_1$o, [
                ($props.title)
                  ? (vue.openBlock(), vue.createBlock("header", _hoisted_2$b, [
                      vue.createVNode("p", _hoisted_3$8, vue.toDisplayString($props.title), 1 /* TEXT */)
                    ]))
                  : vue.createCommentVNode("v-if", true),
                vue.createVNode("section", {
                  class: ["modal-card-body", { 'is-titleless': !$props.title, 'is-flex': $props.hasIcon }]
                }, [
                  vue.createVNode("div", _hoisted_4$6, [
                    ($props.hasIcon && ($props.icon || $options.iconByType))
                      ? (vue.openBlock(), vue.createBlock("div", _hoisted_5$5, [
                          vue.createVNode(_component_b_icon, {
                      ...
                      : vue.createCommentVNode("v-if", true),
                    vue.createVNode("div", _hoisted_6$4, [
                        ...
                        (_ctx.$slots.default)
                          ...
                          : (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 1 }, [
                              ($props.unsafeHtmlMessage)
                                ...
                                : (vue.openBlock(), vue.createBlock("div", _hoisted_7$3, vue.toDisplayString($props.message), 1 /* TEXT */))
                            ], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */))
                      ]),
                      ($props.hasInput)
                        ? (vue.openBlock(), vue.createBlock("div", _hoisted_8$2, [
                            vue.createVNode("div", _hoisted_9$1, [
                            ...
                            vue.createVNode("p", _hoisted_10$1, vue.toDisplayString($data.validationMessage), 1 /* TEXT */)
                          ]))
                        : vue.createCommentVNode("v-if", true)
                    ])
                  ])
                ], 2 /* CLASS */),
                vue.createVNode("footer", _hoisted_11$1, [
                  ($options.showCancel)
    ...
    function createDialog(_onConfirm, _onCancel) {
      ...
      var vueInstance = vue.createApp({
        ...
        render: function render() {
          this.dialogVNode = vue.h(script$F, _objectSpread$7(_objectSpread$7({}, propsData), {}, {
  ...
  function render$y(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("figure", {
      ...
      ($options.isCaptionFirst)
        ? (vue.openBlock(), vue.createBlock("figcaption", _hoisted_1$n, [
      ...
      ($options.isCaptionLast)
        ? (vue.openBlock(), vue.createBlock("figcaption", _hoisted_2$a, [
            vue.renderSlot(_ctx.$slots, "caption")
          ]))
        : vue.createCommentVNode("v-if", true)
    ], 6 /* CLASS, STYLE */))
  ...
  const _hoisted_1$m = /*#__PURE__*/vue.createVNode("div", { class: "loading-icon" }, null, -1 /* HOISTED */);
  ...
  var LoadingProgrammatic = {
    open: function open(params) {
      ...
      var vueInstance = vue.createApp({
        ...
        render: function render() {
          this.loadingVNode = vue.h(script$D, _objectSpread$6(_objectSpread$6({}, propsData), {}, {
  ...
  function render$w(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", _hoisted_1$l, [
      vue.renderSlot(_ctx.$slots, "default")
    ]))
  }
      ...
      (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.tag), vue.mergeProps(_ctx.$attrs, {
        ...
        default: vue.withCtx(() => [
          ($props.icon)
            ...
            : vue.createCommentVNode("v-if", true),
          ($props.label)
            ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$k, vue.toDisplayString($props.label), 1 /* TEXT */))
        ...
        (_ctx.isActive)
          ? (vue.openBlock(), vue.createBlock("article", {
              ...
              (_ctx.$slots.header || _ctx.title)
                ? (vue.openBlock(), vue.createBlock("header", _hoisted_1$j, [
                    (_ctx.$slots.header)
                      ? (vue.openBlock(), vue.createBlock("div", _hoisted_2$9, [
                          vue.renderSlot(_ctx.$slots, "header")
                        ]))
                      : (_ctx.title)
                        ? (vue.openBlock(), vue.createBlock("p", _hoisted_3$7, vue.toDisplayString(_ctx.title), 1 /* TEXT */))
                        : vue.createCommentVNode("v-if", true),
                    (_ctx.closable)
                      ? (vue.openBlock(), vue.createBlock("button", {
                          key: 2,
                ...
                : vue.createCommentVNode("v-if", true),
              (_ctx.$slots.default)
                ? (vue.openBlock(), vue.createBlock("section", _hoisted_4$5, [
                    vue.createVNode("div", _hoisted_5$4, [
                      (_ctx.computedIcon && _ctx.hasIcon)
                        ? (vue.openBlock(), vue.createBlock("div", _hoisted_6$3, [
                            vue.createVNode(_component_b_icon, {
                        ...
                        : vue.createCommentVNode("v-if", true),
                      vue.createVNode("div", _hoisted_7$2, [
                        vue.renderSlot(_ctx.$slots, "default")
                      ])
                    ])
                  ]))
  ...
  var ModalProgrammatic = {
    ...
    open: function open(params) {
      ...
      var vueInstance = vue.createApp({
        ...
        render: function render() {
          this.modalVNode = vue.h(script$G, _objectSpread$5(_objectSpread$5({}, propsData), {}, {
            onClose: function onClose() {
              vueInstance.unmount();
            }
          }), slot ? {
      ...
      default: vue.withCtx(() => [
        vue.withDirectives(vue.createVNode("article", {
          ...
          (_ctx.$slots.default || _ctx.message)
            ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$i, [
                (_ctx.computedIcon && _ctx.hasIcon)
  ...
  var NotificationProgrammatic = {
    open: function open(params) {
      ...
      var vueInstance = vue.createApp({
        ...
        render: function render() {
          this.noticeVNode = vue.h(script$x, _objectSpread$3(_objectSpread$3({}, propsData), {}, {
            onClose: function onClose() {
              if (_onClose != null) {
                _onClose();
  ...
  const _hoisted_1$h = /*#__PURE__*/vue.createVNode("span", { "aria-hidden": "true" }, null, -1 /* HOISTED */);
  const _hoisted_2$7 = /*#__PURE__*/vue.createVNode("span", { "aria-hidden": "true" }, null, -1 /* HOISTED */);
  const _hoisted_3$5 = /*#__PURE__*/vue.createVNode("span", { "aria-hidden": "true" }, null, -1 /* HOISTED */);
  ...
  const _hoisted_5$3 = /*#__PURE__*/vue.createVNode("span", { class: "pagination-ellipsis" }, "…", -1 /* HOISTED */);
  ...
  function render$m(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createBlock("nav", {
      ...
      ($props.simple)
        ? (vue.openBlock(), vue.createBlock("small", _hoisted_1$g, [
            ($props.perPage == 1)
              ? (vue.openBlock(), vue.createBlock(vue.Fragment, { key: 0 }, [
        ...
        : (vue.openBlock(), vue.createBlock("ul", _hoisted_2$6, [
            vue.createCommentVNode("First"),
            ($options.hasFirst)
              ? (vue.openBlock(), vue.createBlock("li", _hoisted_3$4, [
                  (_ctx.$slots.default)
                    ? vue.renderSlot(_ctx.$slots, "default", {
                        key: 0,
            ...
            ($options.hasFirstEllipsis)
              ? (vue.openBlock(), vue.createBlock("li", _hoisted_4$4, [
                  _hoisted_5$3
                ]))
              : vue.createCommentVNode("v-if", true),
            ...
            ($options.hasLastEllipsis)
              ? (vue.openBlock(), vue.createBlock("li", _hoisted_6$2, [
                  _hoisted_7$1
                ]))
              : vue.createCommentVNode("v-if", true),
            ($options.hasLast)
  ...
  function render$l(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      ($options.isNative && $props.showValue)
        ? (vue.openBlock(), vue.createBlock("p", _hoisted_1$f, [
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
  ...
  function render$k(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      ($options.newShowValue)
        ? (vue.openBlock(), vue.createBlock("p", _hoisted_1$e, [
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
              vue.createTextVNode(vue.toDisplayString($options.newValue), 1 /* TEXT */)
            ])
          ]))
      ...
      ($props.showText || $props.showScore || $props.customText)
        ? (vue.openBlock(), vue.createBlock("div", {
            ...
            ($props.customText && !$props.showText)
              ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$c, vue.toDisplayString($props.customText), 1 /* TEXT */))
              : vue.createCommentVNode("v-if", true)
          ], 2 /* CLASS */))
        : vue.createCommentVNode("v-if", true)
    ], 2 /* CLASS */))
      ...
      vue.createVNode(_component_b_tooltip, {
        ...
        default: vue.withCtx(() => [
          vue.createVNode("div", vue.mergeProps({
            ...
            ($props.indicator)
              ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$a, vue.toDisplayString($options.formattedValue), 1 /* TEXT */))
              : vue.createCommentVNode("v-if", true)
  ...
  function render$d(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      (_ctx.$slots.default)
        ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$9, [
            vue.renderSlot(_ctx.$slots, "default")
          ]))
        : vue.createCommentVNode("v-if", true)
    ], 6 /* CLASS, STYLE */))
  ...
  function render$c(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      vue.createVNode("div", _hoisted_1$8, [
        vue.createVNode("div", {
          class: "b-slider-fill",
        ...
        vue.withDirectives(vue.createVNode("div", {
          ...
          ($props.cancelText)
            ? (vue.openBlock(), vue.createBlock("div", {
                ...
                vue.createVNode("button", _hoisted_1$7, vue.toDisplayString($props.cancelText), 1 /* TEXT */)
              ]))
            : vue.createCommentVNode("v-if", true),
          ($props.actionText)
            ? (vue.openBlock(), vue.createBlock("div", {
                ...
                vue.createVNode("button", _hoisted_2$4, vue.toDisplayString($props.actionText), 1 /* TEXT */)
              ], 2 /* CLASS */))
            : vue.createCommentVNode("v-if", true)
        ], 10 /* CLASS, PROPS */, ["role"]), [
          [vue.vShow, _ctx.isActive]
  ...
  var SnackbarProgrammatic = {
    open: function open(params) {
      ...
      var vueInstance = vue.createApp({
        ...
        render: function render() {
          this.snackbarVNode = vue.h(script$e, _objectSpread$2(_objectSpread$2({}, propsData), {}, {
            onClose: function onClose() {
  ...
  function render$a(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      vue.createVNode("nav", {
        ...
        vue.createVNode("ul", _hoisted_1$6, [
              ...
              vue.createVNode("a", {
                ...
                vue.createVNode("div", _hoisted_2$3, [
                  (childItem.icon)
                    ...
                    : (childItem.step)
                      ? (vue.openBlock(), vue.createBlock("span", _hoisted_3$3, vue.toDisplayString(childItem.step), 1 /* TEXT */))
                      : vue.createCommentVNode("v-if", true)
                ]),
                vue.createVNode("div", _hoisted_4$3, [
                  vue.createVNode("span", _hoisted_5$2, vue.toDisplayString(childItem.label), 1 /* TEXT */)
                ])
              ], 10 /* CLASS, PROPS */, ["onClick"])
            ], 2 /* CLASS */)), [
      ...
      vue.renderSlot(_ctx.$slots, "navigation", {
        ...
        ($props.hasNavigation)
          ? (vue.openBlock(), vue.createBlock("nav", _hoisted_6$1, [
              vue.createVNode("a", {
                role: "button",
                class: "pagination-previous",
  ...
  function render$9(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("label", {
      ...
      vue.createVNode("span", _hoisted_1$5, [
        vue.renderSlot(_ctx.$slots, "default")
      ])
    ], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, ["disabled"]))
  }
  ...
  var ToastProgrammatic = {
    open: function open(params) {
      ...
      var vueInstance = vue.createApp({
        ...
        render: function render() {
          this.toastVNode = vue.h(script$1, _objectSpread(_objectSpread({}, propsData), {}, {
  ...
  exports.Autocomplete = Plugin$1f;
  exports.Button = Plugin$1d;
  exports.Carousel = Plugin$1b;
  exports.Checkbox = Plugin$19;
  exports.Clockpicker = Plugin$15;
  exports.Collapse = Plugin$17;
