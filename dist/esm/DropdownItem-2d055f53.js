...
import { t as toCssWidth, q as isCustomElement, d as createAbsoluteElement, r as removeElement } from './helpers-2263d431.js';
import { P as ProviderParentMixin, I as InjectedChildMixin } from './InjectedChildMixin-eb1af2ee.js';
import { resolveDirective, openBlock, createBlock, withModifiers, renderSlot, createCommentVNode, createVNode, Transition, withCtx, withDirectives, vShow } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return ($props.separator)
    ? (openBlock(), createBlock("hr", _hoisted_1))
